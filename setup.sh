...
HP_IMAGE="${HP_IMAGE:-ghcr.io/noctisapi/noctisapi-core}"
...
echo -e "${YELLOW}${BOLD}│  ADMIN PANEL — SAVE THIS NOW                            │${RESET}"
echo -e "${YELLOW}${BOLD}├─────────────────────────────────────────────────────────┤${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}  Panel token : ${BOLD}${HP_PANEL_TOKEN}${RESET}"
echo -e "${YELLOW}${BOLD}├─────────────────────────────────────────────────────────┤${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}  The panel runs on 127.0.0.1:9001 (not public).         ${YELLOW}${BOLD}│${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}  Open an SSH tunnel first, then open your browser:      ${YELLOW}${BOLD}│${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}                                                         ${YELLOW}${BOLD}│${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}    ${CYAN}ssh -L 9001:localhost:9001 admin@${HP_PUBLIC_HOST}${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}    ${CYAN}http://localhost:9001${RESET}  (use token above to login)  ${YELLOW}${BOLD}│${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}                                                         ${YELLOW}${BOLD}│${RESET}"
echo -e "${YELLOW}${BOLD}│${RESET}  To change token: edit HP_PANEL_TOKEN in ${ENV_FILE}${RESET}"
